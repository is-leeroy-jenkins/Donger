...
| Area                 | Responsibility                                                                                                                      |
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Application Shell    | Renders the Donger Streamlit interface and coordinates the active application mode.                                                   |
...
1. Donger initializes required Streamlit UI session-state values.
...
| Page        | Purpose                                                                       |
|-------------|-------------------------------------------------------------------------------|
| `grok.md` | Generated API documentation for reusable Gemini provider wrapper classes.     |
