...
This guide assumes a Windows development workstation using PowerShell from the Donger repository root.
...
```powershell
git clone https://github.com/is-leeroy-jenkins/Donger.git
cd Donger
```
...
```text
https://is-leeroy-jenkins.github.io/Donger/
```
